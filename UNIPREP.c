...
void record(char name[100], char email[100], char subject[100], int score, int count);
int Chemistry(int numofmcqs);
int Biology(int numofmcqs);
int BasicMath(int numofmcqs);
int Maths(int numofmcqs);
int English(int numofmcqs);
int Physics(int numofmcqs);
int IQ(int numofmcqs);
...
int main()
{
    ...
    printf("\nWelcome to UNIPREP - Ultimate way to crack entry tests\n\n");
            ...
            if (field_study == 1)
            {
                if (intermediate_percentage >= 60)
                {
                    ...
                    if (number == 1)
                    {
                        ...
                        {
                            score = Maths(40);
                            record(name, email, "Mathematics", score, 40);
                        }
                        else if (subnum == 2)
                        {
                            score = Physics(30);
                            record(name, email, "Physics", score, 30);
                        }
                        else if (subnum == 3)
                        {
                            score = Chemistry(10);
                            record(name, email, "CHemistry", score, 10);
                        }
                        else if (subnum == 4)
                        {
                            score = English(10);
                            record(name, email, "English", score, 10);
                        }
                        else if (subnum == 5)
                        {
                            score = IQ(10);
                            record(name, email, "IQ", score, 10);
                        }
                        else
                    ...
                    else if (number == 2)
                    {
                        ...
                        {
                            score = Maths(30);
                            record(name, email, "Mathematics", score, 30);
                        }
                        else if (subnum == 3)
                        {
                            score = Chemistry(20);
                            record(name, email, "Chemistry", score, 20);
                        }
                        else if (subnum == 4)
                        {
                            score = English(20);
                            record(name, email, "English", score, 20);
                        }
                        else
                            printf("You entered wrong number");
                    }
                    else if (number == 3)
                    {
                        ...
                        {
                            score = Physics(25);
                            record(name, email, "Physics", score, 25);
                        }
                        else if (subnum == 2)
                        {
                            score = Maths(25);
                            record(name, email, "Mathematics", score, 25);
                        }
                        else if (subnum == 3)
                        {
                            score = Chemistry(25);
                            record(name, email, "Chemistry", score, 25);
                        }
                        else if (subnum == 4)
                        {
                            score = English(25);
                            record(name, email, "English", score, 25);
                        }
                        else
                            printf("You entered wrong number");
                    }
            ...
            else if (field_study == 2)
            {
                if (intermediate_percentage >= 60)
                {
                    ...
                    if (number == 1)
                    {
                        ...
                        {
                            score = Maths(50);
                            record(name, email, "Math", score, 50);
                        }
                        else if (subnum == 2)
                        {
                            score = BasicMath(20);
                            record(name, email, "Basic Math", score, 20);
                        }
                        else if (subnum == 3)
                        {
                            score = IQ(20);
                            record(name, email, "IQ", score, 20);
                        }
                        else if (subnum == 4)
                        {
                            score = English(10);
                    ...
                    else if (number == 2)
                    {
                        ...
                        {
                            score = Maths(40);
                            record(name, email, "Math", score, 40);
                        }
                        else if (subnum == 2)
                        {
                            score = English(30);
                            record(name, email, "English", score, 30);
                        }
                        else if (subnum == 3)
                        {
                            score = IQ(20);
                        ...
                        {
                            score = Physics(10);
                            record(name, email, "Physics", score, 10);
                        }
                        else
                            printf("You entered wrong number");
                    }
                    else if (number == 3)
                    {
                        ...
                        {
                            score = Physics(20);
                            record(name, email, "Physics", score, 20);
                        }
                        else if (subnum == 4)
                        {
                            score = IQ(10);
                ...
                else
                {
                    ...
                    if (number == 1 || number == 2 || number == 3)
                    {
                        ...
                        {
                            score = Maths(25);
                            record(name, email, "Math", score, 25);
                        }
                        else if (subnum == 2)
                        {
                            score = English(25);
            ...
            else if (field_study == 3)
            {
                if (intermediate_percentage >= 60)
                {
                    ...
                    if (number == 1)
                    {
                        ...
                        {
                            score = Biology(40);
                            record(name, email, "Biology", score, 40);
                        }
                        else if (subnum == 2)
                        {
                            score = Chemistry(30);
                            record(name, email, "Chemistry", score, 30);
                        }
                        else if (subnum == 3)
                        {
                            score = Physics(20);
                ...
                else
                {
                    ...
                    if (number == 1 || number == 2 || number == 3)
                    {
                        ...
                        {
                            score = Biology(25);
                            record(name, email, "Biology", score, 25);
                        }
                        else if (subnum == 2)
                        {
                            score = Chemistry(25);
...
int Maths(int numofmcqs)
{
    ...
    for (questionCount = 0; questionCount < numofmcqs; questionCount++)
    {
        lineLength = rand() % 50;
...
void record(char name[100], char email[100], char subject[100], int score, int count)
{
    ...
    fprintf(record, "\n%s | %s | %s | %d | %d", name, email, subject, score, count);
    fclose(record);
}
...
void leaderboard()
{
    ...
    while (fgets(line, sizeof(line), file))
    {
        ...
        if (sscanf(line, " %[^|] | %[^|] | %[^|] | %d | %d",
                   records[size].name,
                   records[size].email,
                   records[size].subject,
                   &records[size].score,
				   &records[size].total) == 5)
        {
            size++;
        }
    }
    ...
    qsort(records, size, sizeof(Record), compareScore);
    ...
    for (i = 0; i < size; i++)
    {
        printf("%4d | %-20s | %-12s | %d/%d\n", i + 1,
               records[i].name, records[i].subject, records[i].score,records[i].total);
    }
}
